...
def aREA(gesObj, intObj):
    ...
    interactomeTargetSet = intObj.get_targetSet()
    expressionMatrixGeneNames = gesObj.var_names.to_list()
    intersectGenes = [value for value in interactomeTargetSet if value in expressionMatrixGeneNames]
    # print(len(intersectGenes))
    ...
    gesInds = [expressionMatrixGeneNames.index(i) for i in intersectGenes]
