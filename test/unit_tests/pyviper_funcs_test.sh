...
echo "BASH running test_InteractomeToTable_func.R."
mkdir -p test_2/test_2_outputs/
Rscript test_scripts/test_InteractomeToTable_func.R \
--net_obj=test_2/test_2_inputs/LCRN1_pruned.rds \
--out_name_project=LCRN1 \
--out_dir=test_2/test_2_outputs/

echo "BASH running test_aREA_func.R."
Rscript test_scripts/test_aREA_func.R \
--ges=test_2/test_2_inputs/LCRN1_gExpr_GES.rds \
--network=test_2/test_2_inputs/LCRN1_pruned.rds \
--out_name_project=LCRN1 \
--out_dir=test_2/test_2_outputs/

echo "BASH running GENERAL_convert_to_csv_forTesting.R."
Rscript test_scripts/GENERAL_convert_to_csv_forTesting.R \
--file=test_2/test_2_outputs/LCRN1_aREA_PAct.rds \
--ext=tsv \
--out_dir=test_2/test_2_outputs/
...
echo "BASH running test_InteractomeToTable_func.R."
mkdir -p test_3/test_3_outputs/
Rscript test_scripts/test_InteractomeToTable_func.R \
--net_obj=test_3/test_3_inputs/AJ081_pruned.rds \
--out_name_project=AJ081 \
--out_dir=test_3/test_3_outputs/

echo "BASH running test_aREA_func.R."
Rscript test_scripts/test_aREA_func.R \
--ges=test_3/test_3_inputs/AJ081_gExpr_GES.rds \
--network=test_3/test_3_inputs/AJ081_pruned.rds \
--out_name_project=AJ081 \
--out_dir=test_3/test_3_outputs/

echo "BASH running GENERAL_convert_to_csv_forTesting.R."
Rscript test_scripts/GENERAL_convert_to_csv_forTesting.R \
--file=test_3/test_3_outputs/AJ081_aREA_PAct.rds \
--ext=tsv \
--out_dir=test_3/test_3_outputs/
